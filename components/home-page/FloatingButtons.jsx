    ...
    return (
        <>
            ...
            >
                ...
                {/* Divider - Fading Gold Gradient for elegance */}
                <div className="w-8 h-[1px] bg-gradient-to-r from-transparent via-[#d4af37]/60 to-transparent"></div>
                ...
                >
                    <FaWhatsapp
                        size={22}
                        className="text-[#25D366] transition-colors duration-300 group-hover:text-white"
                    />
                </a>
