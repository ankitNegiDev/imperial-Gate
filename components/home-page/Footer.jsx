...
function Footer() {
    ...
    return (
        <footer className="w-full pt-0 pb-10 bg-black">
            ...
            {/* CENTERED TEXT */}
            <p className="text-gray-400 text-center text-base w-[90vw] lg:max-w-[35vw] mx-auto mb-12 pl-0 lg:pl-10">
                We deliver premium craftsmanship, innovative solutions, and luxury digital experiences for global brands.
            </p>
                    ...
                    <div className="flex flex-col items-start gap-3">
                        ...
                        <div className="flex gap-4 mt-2">
                            {[FaFacebookF, FaInstagram, FaLinkedinIn].map((Icon, i) => (
                                <div
                                    key={i}
                                    className="w-10 h-10 flex items-center justify-center rounded-full border border-[#fac21e] text-[#fac21e] hover:bg-[#8f7c45] hover:text-black transition hover:shadow-[0_0_12px_#8f7c45] hover:cursor-pointer"
                                >
                                    <Icon size={18} />
                                </div>
                            ))}
