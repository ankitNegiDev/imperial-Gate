...
//! hydration issue - because of comments inside style
...
//         { name: "Designer Entry Gates", image: "/product-image.jpg" },
//         { name: "Modern Steel Doors", image: "/product-image.jpg" },
//         { name: "Premium Balcony Railings", image: "/products-page-img/2-Brass-Balcony-Railing/2-BBR-(1).jpg" },
//         { name: "Security Doors", image: "/product-image.jpg" },
//         { name: "Laser Cut Panels", image: "/products-page-img/4-Lasercut-Boundary-wall-Doors/4-LBD-(3).jpg" },
//         { name: "Boundary Wall Designs", image: "/products-page-img/2-Modern-Boundry-wall-Doors/3-MBW-(5).jpg" }
//     ];
...
function ProductListing() {
    ...
    function renderItems() {
        return categories.map(function (item, index) {
            return (
                ...
                >
                    {/* IMAGE CARD */}
                    <div className="relative w-full aspect-square md:w-full md:aspect-square lg:w-56 lg:h-56 rounded-2xl overflow-hidden border border-[#8f7c45]/70 shadow-[0_0_15px_rgba(143,124,69,0.15)] hover:shadow-[0_0_35px_rgba(143,124,69,0.25)] hover:scale-105 transition-all duration-300 bg-black hover:cursor-pointer group">
                        <Image
                            src={item.image}
                            alt={item.name}
                            fill
                    ...
                    {/* TITLE */}
                    <p className="mt-3 md:mt-4 text-sm md:text-base lg:text-lg font-semibold tracking-wide text-[#fac21e] uppercase text-center leading-tight px-1">
                        {item.name}
                    </p>
                </div>
            );
    ...
    return (
        <section className="w-full py-10 md:py-16 lg:py-20 px-4 md:px-8 bg-[#0d0d0d] text-white">
            ...
            {/* GRID */}
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-3 gap-y-6 md:gap-x-6 md:gap-y-10 lg:gap-x-6 lg:gap-y-14 justify-items-center max-w-7xl mx-auto">

                {renderItems()}

                {/* VIEW ALL BOX */}
                <div className="flex flex-col items-center justify-center w-full aspect-square md:w-full md:aspect-square lg:w-56 lg:h-56 rounded-2xl border border-[#8f7c45] bg-gradient-to-br from-black/60 to-black/20 backdrop-blur-xl shadow-lg hover:cursor-pointer transition-all duration-300 active:scale-95 md:active:scale-100 md:hover:scale-105">
                    <p className="text-2xl md:text-2xl lg:text-3xl font-bold text-[#fac21e]">10+</p>
                    <p className="text-gray-300 text-xs md:text-sm">Categories</p>
                    <p className="text-gray-300 text-xs md:text-sm">Available</p>

                    <button className="mt-3 px-4 py-1.5 md:px-4 md:py-1 border border-[#8f7c45] rounded-md text-[#fac21e] text-[11px] md:text-xs hover:bg-[#8f7c45] hover:text-black transition-all duration-300 hover:cursor-pointer">
                        VIEW ALL
                    </button>
                </div>
